...
import { createGameBaseSchema, validateAttendanceRestriction } from "./create-game";

export const updateGameSchema = createGameBaseSchema
  .omit({ sport: true })
  .extend({ gameId: z.string() })
  .superRefine(validateAttendanceRestriction);
