	...
	return (
		...
		>
			...
			<input
				...
				data-slot="input"
				className={cn(
					"placeholder:text-muted-foreground selection:bg-primary group-hover:border-ring selection:text-primary-foreground bg-input flex h-9 w-full min-w-0 border px-3 py-1 text-base transition-[color,box-shadow,border-color] outline-none disabled:pointer-events-none disabled:opacity-50 md:text-sm",
